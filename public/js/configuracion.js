...
$(function () {
  ...
  $(document).on("click", ".newLecturista", function (e) {
    ...
    var url = currentURL + '/lecturistas/create';
    $.get(url, function (data, textStatus, jqXHR) {
      $('#modal').modal('show');
      $("#modal-body").html(data);
    });
  ...
  $(document).on('click', '.saveLecturista', function (event) {
    ...
    var url = currentURL + '/lecturistas';
    $.post(url, {
      nombre: nombre,
      apellidos: apellidos,
      telefono: telefono,
  ...
  $(document).on("click", ".editLecturista", function (e) {
    ...
    var id = $("#idSeleccionado").val();
    var url = currentURL + "/lecturistas/" + id + "/edit";
    $.get(url, function (data, textStatus, jqXHR) {
      $('#modal').modal('show');
      $("#modal-body").html(data);
    });
  ...
  $(document).on('click', '.updateLecturista', function (event) {
    ...
    var _method = "PUT";
    var url = currentURL + '/lecturistas/' + id;
    $.ajax({
      url: url,
      type: 'POST',
      data: {
...
/***/ 0:
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** multi ./resources/js/module_config/menu.js ./resources/js/module_config/precio-gas.js ./resources/js/module_config/usuarios.js ./resources/js/module_config/mensajes.js ./resources/js/module_config/empresas.js ./resources/js/module_config/menus.js ./resources/js/module_config/servicios.js ./resources/js/module_config/lecturistas.js ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/miguellugo/Documents/Desarrollos/Personales/admigas/resources/js/module_config/menu.js */"./resources/js/module_config/menu.js");
__webpack_require__(/*! /Users/miguellugo/Documents/Desarrollos/Personales/admigas/resources/js/module_config/precio-gas.js */"./resources/js/module_config/precio-gas.js");
__webpack_require__(/*! /Users/miguellugo/Documents/Desarrollos/Personales/admigas/resources/js/module_config/usuarios.js */"./resources/js/module_config/usuarios.js");
__webpack_require__(/*! /Users/miguellugo/Documents/Desarrollos/Personales/admigas/resources/js/module_config/mensajes.js */"./resources/js/module_config/mensajes.js");
__webpack_require__(/*! /Users/miguellugo/Documents/Desarrollos/Personales/admigas/resources/js/module_config/empresas.js */"./resources/js/module_config/empresas.js");
__webpack_require__(/*! /Users/miguellugo/Documents/Desarrollos/Personales/admigas/resources/js/module_config/menus.js */"./resources/js/module_config/menus.js");
__webpack_require__(/*! /Users/miguellugo/Documents/Desarrollos/Personales/admigas/resources/js/module_config/servicios.js */"./resources/js/module_config/servicios.js");
module.exports = __webpack_require__(/*! /Users/miguellugo/Documents/Desarrollos/Personales/admigas/resources/js/module_config/lecturistas.js */"./resources/js/module_config/lecturistas.js");
