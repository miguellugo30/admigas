...
$(function () {
  ...
  document.getElementById("viewRecibo").addEventListener("click", function (event) {
    var recibo_id = document.getElementById('recibos').value;

    if (recibo_id === '') {
      Swal.fire('Error!', 'Debe seleccionar una fecha, para mostrar un recibo.', 'error');
    } else {
  ...
  document.getElementById("downloadRecibo").addEventListener("click", function (event) {
    ...
    if (recibo_id === '') {
      Swal.fire('Error!', 'Debe seleccionar una fecha, para descargar un recibo.', 'error');
    } else {
  ...
  $(document).on('click', '#actionSave', function (event) {
    ...
    var url = currentURL + "/update_departamento/" + departamento_id;
    $.post(url, {
      nombre: nombre,
      ...
      $('#modal').modal('hide');
      Swal.fire('Correcto!', 'La información se actualizado correctamente.', 'success');
    }).fail(function (data) {
...
/***/ 2:
/*!***************************************************************!*\
  !*** multi ./resources/js/module_cliente/acciones_cliente.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
