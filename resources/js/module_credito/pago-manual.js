$(function() {
    ...
    $(document).on("click", ".aplicar-pago-button", function(e) {
        ...
        let fecha = $("#fecha").val();
        let unidad = $("#unidad_no_conciliado").val();
        let edificio = $("#edificio_no_conciliado").val();
        let depto = $("#depto_no_conciliado").val();
        ...
        let url = currentURL + '/pagos-manual';
        ...
        .done(function(data) {
            ...
            Swal.fire(
                'Correcto!',
                'El pago se ha registro correctamente.',
                'success'
            )
