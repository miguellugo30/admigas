    ...
    <div class="card-body table-responsive table-striped table-sm container">
        <div class="row justify-content-md-center">
            <form class="form-inline">
                ...
                @csrf
                <button type="submit" class="btn btn-primary mb-2 btn-sm generateReporteRecibosGenerados"><i class="fas fa-cogs"></i> Generar</button>
                <button type="submit" class="btn btn-primary mb-2 ml-2 btn-sm exportReporteRecibosGenerados" style="display: none"><i class="fas fa-download"></i> Descargar</button>
            </form>
        </div>
