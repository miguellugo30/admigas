<style>
    ...
    .invoice-info-history .der .hijo-der{
       ...
       @php
	    ...
	    if( $recibos->lectura_actual < $recibos->lectura_anterior ) {
		$m3 = ( $recibos->lectura_actual + 9999.999 ) - $recibos->lectura_anterior;
	    } else {
	    	$m3 = $recibos->lectura_actual - $recibos->lectura_anterior;
       ...
       <div class="cols">
           <div class="col1">
               <div class="col data-client">
                   ...
                   @if (
                       $recibos->admigas_condominios_id == 7 ||
                        $recibos->admigas_condominios_id == 8 ||
                        $recibos->admigas_condominios_id == 11 ||
                        $recibos->admigas_condominios_id == 12
                   )
	        ...
	        @elseif( $recibos->admigas_condominios_id == 78)
			<p class="address">{{ $recibos->calle." ".$recibos->numero_exterior." ".$recibos->condominio." ".$recibos->numero_interior }}</p>
                        <p class="address">{{ $recibos->colonia." ".$recibos->cp.", ".$recibos->delegacion }}, CDMX</p>
		@else
		...
		@endif
               ...
               <div class="row invoice-info-page">
                   <div class="izq">
                       ...
                       <div class="hijo-der">
                           ...
                           <legend>{{ number_format( ( $m3 ) * $recibos->Condominios->factor, 2 ) }}</legend><br>
                       </div>
                   </div>
                   <div class="der">
                       <div class="hijo-izq">
			...
			@if ($recibos->admigas_condominios_id == 116 || $recibos->admigas_condominios_id == 117 || $recibos->admigas_condominios_id == 118)

                                @php
                                    $carpetaFechaAnt = $recibos->fecha_lectura_anterior;
                                    $carpetaFechaAct = $recibos->fecha_lectura_actual;
                                @endphp

                        @else

                                @php
                                    $carpetaFechaAnt = date('m-Y', strtotime($recibos->fecha_lectura_anterior));
                                    $carpetaFechaAct = date('m-Y', strtotime($recibos->fecha_lectura_actual));
                                @endphp
	     ...
	     <div class="row invoice-info-images">
                    <div class="izq" style="text-align: center;">
                        @if ( \Storage::exists( $empresa_id.'/'.$recibos->admigas_condominios_id.'/'.$carpetaFechaAnt.'/'.$recibos->admigas_departamentos_id."_".$recibos->numero_departamento.".jpeg" ) )
				<img src="{{'data:image/jpeg;base64,' . base64_encode($foto_anterior)}}" alt="" width="100px" >
                    ...
                    <div class="der" style="text-align: center;">
                        ...
                        @if ( \Storage::exists( $empresa_id.'/'.$recibos->admigas_condominios_id.'/'.$carpetaFechaAct.'/'.$recibos->admigas_departamentos_id."_".$recibos->numero_departamento.".jpeg" ) )
