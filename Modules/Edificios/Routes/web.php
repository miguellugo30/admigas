...
Route::group(['namespace' => '\Modules\Edificios\Http\Controllers', 'prefix' => 'edificios', 'middleware' => 'auth'], function() {
    ...
    Route::get('departamentos/create/{id_edificio}', 'DepartamentosController@create' )->name('departamentos.create-two');
...
Route::get('departamentos/show_recibo_app/{id_departamentos}/{id_recibo}', 'DepartamentosController@show_recibo' )->name('mostrar_recibo_api.departamentos');
/*
 * Rutas para CRUD de Departamentos
 */
Route::group(['namespace' => '\Modules\Edificios\Http\Controllers', 'prefix' => 'edificios', 'middleware' => 'auth'], function() {
    ...
    Route::post('captura-lectura-inicial', 'CapturaLecturaController@capturaLecturaInicial' )->name('captura.lectura.inicial');
});
...
Route::group(['namespace' => '\Modules\Edificios\Http\Controllers', 'prefix' => 'edificios', 'middleware' => 'auth'], function() {
    ...
    Route::get('enviar-recibos/{id_condominios}', 'RecibosController@showPhoto' )->name('show-photo.recibos');
